...
public class SquaresTable {
    public static final String TABLE_SQUARES = "squares";

    private static final String DATABASE_CREATE = "create table " + TABLE_SQUARES + "("
    ...
    public static void onUpgrade(final SQLiteDatabase database, final int oldVersion, final int newVersion) {
        ...
        database.execSQL("DROP TABLE IF EXISTS " + TABLE_SQUARES);
        onCreate(database);
    }
